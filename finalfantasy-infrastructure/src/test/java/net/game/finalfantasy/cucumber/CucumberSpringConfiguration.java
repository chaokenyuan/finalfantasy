...
import net.game.finalfantasy.infrastructure.config.TestConfiguration;
...
@SpringBootTest(
        classes = {TestConfiguration.class, CucumberSpringConfiguration.TestConfig.class},
...
public class CucumberSpringConfiguration {
    ...
    public void onApplicationReady() {
        System.out.println("[DEBUG_LOG] Application ready event fired");
    }
    ...
    static class TestConfig {
        ...
        public HttpServer vertxHttpServer() {
            ...
            System.out.println("[DEBUG_LOG] Creating Vert.x HTTP server bean...");
            ...
            try {
                ...
                System.out.println("[DEBUG_LOG] Vert.x HTTP server started successfully on port 8081");
            } catch (Exception e) {
